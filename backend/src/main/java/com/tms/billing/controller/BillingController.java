...
public class BillingController {
    ...
    @GetMapping("/page")
    public R<Page<FreightBill>> page(
    ...
    public static class CalcReq {
        private String carrierCode, chargeType;
        private Long orderId;
        private java.util.List<com.tms.order.entity.TransportOrderLine> lines;
        private BigDecimal volumeRatio, distanceKm;
    }
}
